...
urlpatterns = [
    ...
    path('link/<int:pk>/', views.link_detail, name='link_detail'),
    path('link/<int:pk>/edit/', views.edit_link, name='edit_link'),
    path('link/<int:pk>/delete/', views.delete_link, name='delete_link'),
    path('link/<int:pk>/like/', views.toggle_like, name='toggle_like'),
    path('link/<int:pk>/comment/', views.add_comment, name='add_comment'),
